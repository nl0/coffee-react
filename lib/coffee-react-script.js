...
CoffeeScript = Object.assign({}, require('coffee-script/lib/coffee-script/coffee-script'));

jsSyntaxTransform = require('coffee-react-jstransform');

if (!CoffeeScript._cjsx) {
  CoffeeScript._cjsx = true;
  CoffeeScript.FILE_EXTENSIONS = slice.call(CoffeeScript.FILE_EXTENSIONS).concat(['.cjsx']);
